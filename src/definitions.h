...
inline constexpr auto STATUS_SERVER_NAME = "Forgotten Server";
inline constexpr auto STATUS_SERVER_VERSION = "1.5";
inline constexpr auto STATUS_SERVER_DEVELOPERS = "Johncorex";
inline constexpr auto STATUS_SERVER_REPOSITORY = "https://github.com/Johncorex/TFS-1.5-860";
