...
void printServerVersion()
{
	...
	std::cout << "Downgraded and developed by Johncorex" << std::endl;
	std::cout << "Visit our github for updates, support, and resources: https://github.com/Johncorex/TFS-1.5-860." << std::endl;
	std::cout << std::endl;
